...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var tvWinner = findViewById<TextView>(R.id.tvWinner)
        var ivWinner = findViewById<ImageView>(R.id.ivWinner)
        ...
        tvWinner.text = imageName[maxIndex]
        ivWinner.setImageResource(imageFileId[maxIndex])
